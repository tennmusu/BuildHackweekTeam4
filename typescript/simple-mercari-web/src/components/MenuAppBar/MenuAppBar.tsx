...
export const MenuAppBar: React.FC<{}> = () => {
  ...
  const user: UserType = {
    ...
    uuid:authUser.getUser()?.uuid||0,
    role: authUser.getUser()?.role||RoleType.User,
  };
  const signin = () => {
    authUser.signin(user, () => {
      document.location.href = "http://localhost:3000/user/"+user.uuid;
    });
  };
  return (
    <Box sx={{ flexGrow: 1 }}>
          ...
          <Toolbar>
            ...
            <div>
              ...
              <Menu
                ...
                onClose={handleClose}
              >
                <MenuItem sx={{ width: 160,gap:1}} onClick={signin}>
