...
export const MyItemDetail: React.FC<{}> = () => {
  const initialState = {
    item_uuid: 0,
    item_name: "",
    category_name: "",
        ...
        <>
            ...
            >
              ...
              <Button
                ...
                color="primary"
                sx={{ mt:-1.5 }}
                onClick={() => navigator.clipboard.writeText("http://localhost:3000/content/item/"+item.item_uuid)}
              >
                copy the link
              </Button>
            </CardActions>
            ...
            {isBarter&&(<Stack sx={{pt:2}} direction="row"  justifyContent="center"><Apply/></Stack>)}
        </>
      )}
    </>
  );
